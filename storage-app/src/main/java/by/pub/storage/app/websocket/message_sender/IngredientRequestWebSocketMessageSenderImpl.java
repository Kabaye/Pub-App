...
@Component
public class IngredientRequestWebSocketMessageSenderImpl implements IngredientRequestWebSocketMessageSender {
    private final SimpMessagingTemplate simpMessagingTemplate;

    public IngredientRequestWebSocketMessageSenderImpl(SimpMessagingTemplate simpMessagingTemplate) {
